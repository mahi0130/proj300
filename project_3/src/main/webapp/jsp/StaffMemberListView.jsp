	...
	<div>
		<form class="pb-5" action="<%=ORSView.STAFFMEMBER_LIST_CTL%>"
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="identifier" oninput="validateNumericInput(this)" maxlength="16"
						placeholder="Enter identifier" class="form-control"
				...
				<div class="row">
					...
					<div class="col-sm-3">
						...
						<font color="red" class="pl-sm-5" id="division"></font>
					</div>
					...
					<div class="col-sm-2">
						<input type="text" name="previousEmployer" oninput="handleLetterInput(this, 'previousEmployerError', 20)"
					...
					<table class="table table-bordered table-dark table-hover">
						<thead>
							<tr style="background-color: purple;">
								...
								<th width="15%" class="text">Identifier</th>
								<th width="20%" class="text">FullName</th>
						...
						<tbody>
							<tr>
								...
								<td class="text"><%=dto.getIdentifier()%></td>
